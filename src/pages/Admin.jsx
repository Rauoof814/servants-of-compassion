                ...
                <section className="grid gap-6">
                    ...
                    {tab === "brand" && (
                        <div className="card p-6 grid md:grid-cols-2 gap-3">
                            ...
                            <input
                                className="input"
                                placeholder="Paste a full https:// URL or upload below"
                                value={brand.logo}
                                onChange={(e) => setBrand({ ...brand, logo: e.target.value })}
                            />
                            {/* NEW: upload logo to Supabase and store its public URL */}
                                ...
                                <input
                                    ...
                                    onChange={async (e) => {
                                        ...
                                        try {
                                            ...
                                            alert("Logo uploaded. Click 'Save Brand' to persist it.");
                                        } catch (err) {
                    ...
                    {/* --- the rest of your tabs (events/blog/media/press/resources/i18n/data) remain exactly as you posted --- */}
                </section>
            </div>
        </main>
    );
